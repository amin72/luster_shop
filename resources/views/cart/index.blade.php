...
<div class="max-w-7xl mx-auto px-8 py-6 rounded border shadow-xl">
  ...
  @if (Cart::isEmpty())
    <div class="mt-4 text-xl text-center">
      سبد خرید خالی است. برای مشاهده محصولات به <a class="text-red-400" href="{{ route('products.index') }}">فروشگاه</a> بروید.
    </div>
  @else
    {{-- display cart items --}}
    <div class="text-center text-gray-700">
      ...
      <div class="flex flex-col border-b-2 pb-4">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center">
          ...
          <div class="flex items-center lg:w-7/12">
            <span class="w-1/4 md:w-1/6 text-right flex-shrink-0 lg:hidden font-semibold">نام محصول:</span>
          ...
          <div class="flex items-center lg:w-1/12 lg:ml-1">
            <span class="text-right w-1/4 md:w-1/6 flex-shrink-0 lg:hidden font-semibold">تعداد:</span>
          ...
          <div class="flex justify-between flex-col lg:flex-row lg:w-4/12">
            ...
            <div class="flex justify-between items-center w-full lg:ml-1">
              <span class="text-right w-1/4 md:w-1/6 flex-shrink-0 lg:hidden font-semibold">قیمت واحد:</span>
            ...
            <div class="flex py-5 md:justify-start lg:justify-end">
        ...
        <div class="text-right">
          <h4 class="lg:pr-2 text-lg font-semibold">ویژگی های محصول</h4>
          <ul class="pr-6 list-disc lg:text-lg">
            @foreach ($item->attributes as $attribute_product)
            <li class="my-2">
              <span class="">{{ $attribute_product->attribute->name }}: </span>
              <span>{{ $attribute_product->value }}</span>
            </li>
            @endforeach
          </ul>
        </div>
      ...
      <div class="flex flex-col lg:flex-row items-center mt-6">
        ...
        <div class="lg:w-1/2 w-full h-16 flex justify-between items-center bg-gray-300 rounded-xl my-2 ml-2">
          <a
            class="checkout h-full w-full justify-center font-semibold text-xl rounded-xl tracking-widest block text-center text-white rounded-lg inline-flex items-center px-4 py-3 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150"
